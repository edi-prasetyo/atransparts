                                ...
                                <div class="card-img-cover">
                                    <div class="card-img-frame">
                                        <img src="{{ asset($product->productImages[0]->image ?? '') }}"
                                            class="card-img-top mb-3" alt="{{ $product->slug }}">
                                    </div>
                                </div>
                            </a>
                            <div class="card-body">
                                ...
                                <p>{{ Str::limit(strip_tags($product->description), 80) }}
                                </p>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(index, post) {
                        posts_html +=
                            '<div class="col-md-3"><div class="card mb-3"><img class="img-fluid" src="' +
                            post.yoast_head_json.og_image[0].url + '">';
                        posts_html +=
                            '<div class="card-body"><a class="text-decoration-none text-muted" href="' +
                            post.link + '"><h4>' + post.title.rendered + '</h4></a></div>';
                        posts_html +=
                            '<div class="card-footer bg-white text-muted"><p> <i class="bx bx-user me-3"></i>' +
                            post.yoast_head_json.author + '</p></div></div></div>';
