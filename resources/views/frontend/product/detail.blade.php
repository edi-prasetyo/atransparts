                        ...
                        <tbody>
                            @foreach ($part_number as $key => $part)
                                <tr>
                                    ...
                                    <td>
                                        <div class="text-end">
                                            <a href="https://wa.me/{{ $option_nav->whatsapp }}?text=Halo%20Saya%20Ingin%20Informasi%20Tentang%20Produk%20**{{ $product->name }}**%20yang%20saya%20lihat%20di%20{{ url(LaravelLocalization::getCurrentLocale() . '/product/' . $product->slug) }} dengan produk number {{ $part->number }}"
